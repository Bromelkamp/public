...
if (!$DryRun) {
    $spn = New-AzureADServicePrincipal -AccountEnabled $true -AppId "a86b9632-42bf-4dfe-83c8-bbc95145504b" -AppRoleAssignmentRequired $true -DisplayName "$spnDisplayName" -Tags {WindowsAzureActiveDirectoryIntegratedApp}
    $spnId = $spn.ObjectId
